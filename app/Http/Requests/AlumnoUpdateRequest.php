...
class AlumnoUpdateRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'nombre.max' => 'El nombre del alumno(a) debe ser menor a 30 caracteres.',
            'nombre.min' => 'El nombre del alumno(a) debe ser mayor a 3 caracteres.',
            'matricula.max' => 'El apellido parterno del alumno(a) debe ser menor a 30 caracteres.',
            'matricula.min' => 'El apellido parterno del alumno(a) debe ser mayor a 3 caracteres.',
